...
BUILD_ROOT=../../build
SRC_ROOT=examples/92_blackwell_moe_gemm

BUILD_TARGET=92_blackwell_moe_gemm_all

# RUN_TARGET=92_blackwell_moe_gemm_regular
# RUN_TARGET=92_blackwell_moe_gemm_grouped
RUN_TARGET=92_blackwell_moe_gemm_fp4_regular
# RUN_TARGET=92_blackwell_moe_gemm_fp4_grouped
...
CMD="$BUILD_ROOT/$SRC_ROOT/$RUN_TARGET --m=$M --n=$N --k=$K --l=$g --no_verif"
