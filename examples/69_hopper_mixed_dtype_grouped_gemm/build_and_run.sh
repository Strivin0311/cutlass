...
BUILD_ROOT=../../build
SRC_ROOT=examples/69_hopper_mixed_dtype_grouped_gemm

BUILD_TARGET=69_hopper_mixed_dtype_grouped_gemm_all

RUN_TARGET=69_hopper_mixed_dtype_grouped_gemm
# RUN_TARGET=69_hopper_int4_fp8_grouped_gemm
# RUN_TARGET=69_hopper_int4_bf16_grouped_gemm
