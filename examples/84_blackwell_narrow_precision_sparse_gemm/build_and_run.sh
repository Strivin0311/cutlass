...
BUILD_ROOT=../../build
SRC_ROOT=examples/84_blackwell_narrow_precision_sparse_gemm

BUILD_TARGET=84_blackwell_narrow_precision_sparse_gemm_all

# RUN_TARGET=84a_blackwell_nvfp4_bf16_sparse_gemm
RUN_TARGET=84b_blackwell_mixed_mxfp8_bf16_sparse_gemm
