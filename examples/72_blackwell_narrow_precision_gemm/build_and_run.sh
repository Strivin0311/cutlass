...
BUILD_ROOT=../../build
SRC_ROOT=examples/72_blackwell_narrow_precision_gemm

BUILD_TARGET=72_blackwell_narrow_precision_gemm_all

RUN_TARGET=72a_blackwell_nvfp4_bf16_gemm
# RUN_TARGET=72b_blackwell_nvfp4_nvfp4_gemm
# RUN_TARGET=72c_blackwell_mixed_mxfp8_bf16_gemm
