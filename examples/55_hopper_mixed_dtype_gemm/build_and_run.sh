...
BUILD_ROOT=../../build
SRC_ROOT=examples/55_hopper_mixed_dtype_gemm

BUILD_TARGET=55_hopper_mixed_dtype_gemm_all

RUN_TARGET=55_hopper_mixed_dtype_gemm
# RUN_TARGET=55_hopper_int4_fp8_gemm
# RUN_TARGET=55_hopper_int4_bf16_gemm
