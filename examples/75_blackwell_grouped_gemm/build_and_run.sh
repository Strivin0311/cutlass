...
BUILD_ROOT=../../build
SRC_ROOT=examples/75_blackwell_grouped_gemm

BUILD_TARGET=75_blackwell_grouped_gemm_all

# RUN_TARGET=75_blackwell_grouped_gemm
RUN_TARGET=75_blackwell_grouped_gemm_block_scaled
