...
BUILD_ROOT=../../build
SRC_ROOT=examples/81_blackwell_gemm_blockwise

BUILD_TARGET=81_blackwell_gemm_blockwise_all

RUN_TARGET=81_blackwell_gemm_blockwise
# RUN_TARGET=81_blackwell_gemm_groupwise
# RUN_TARGET=81_blackwell_grouped_gemm_blockwise
# RUN_TARGET=81_blackwell_grouped_gemm_groupwise
