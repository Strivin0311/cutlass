...
BUILD_ROOT=../../build
SRC_ROOT=examples/15_ampere_sparse_tensorop_gemm

BUILD_TARGET=15_ampere_sparse_tensorop_gemm_all

RUN_TARGET=15_ampere_sparse_tensorop_gemm
# RUN_TARGET=15_ampere_sparse_tensorop_gemm_universal
# RUN_TARGET=15_ampere_sparse_tensorop_gemm_with_visitor
