...
BUILD_ROOT=../../build
SRC_ROOT=examples/47_ampere_gemm_universal_streamk

BUILD_TARGET=47_ampere_gemm_universal_streamk_all

RUN_TARGET=47_ampere_gemm_universal_streamk
# RUN_TARGET=47_ampere_gemm_universal_streamk_broadcast
