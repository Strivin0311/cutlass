...
BUILD_ROOT=../../build
SRC_ROOT=examples/14_ampere_tf32_tensorop_gemm

TARGET=14_ampere_tf32_tensorop_gemm
...
CMD="$BUILD_ROOT/$SRC_ROOT/$TARGET --m=8192 --n=6144 --k=2048 --alpha=1.5 --beta=0.75"
